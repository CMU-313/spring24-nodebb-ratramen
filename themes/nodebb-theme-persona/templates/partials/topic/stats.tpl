<div class="stats text-muted">
    ...
    <!-- IF votes --> 
    <div class="stats pin-post" style="border: 3px solid #dcb841; background-color: #fff9db; text-align: center; color: #333; height: 35px; line-height: 30px; margin-top: 20px; font-weight: bold; font-style: italic; border-radius: 5px; align-items: center; padding: 0 10px;">
        Pinned
    </div>
    <!-- END --> 
</div>